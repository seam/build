...
REPOS="build dist examples catch documents drools faces international jbpm jms persistence js-remoting resteasy security servlet wicket xml-config clouds ticket-monster"
